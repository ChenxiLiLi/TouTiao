...
import com.bytedance.toutiao.ui.user.adapter.UserPublishInfoAdapter;
import com.bytedance.toutiao.viewmodel.MyViewModel;

import java.util.ArrayList;
import java.util.List;

public class FragmentUserPublishInfo extends BaseFragment<MyViewModel, FragmentUserInfoBinding> {
    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private UserPublishInfoAdapter userInfoAdapter;
    private List<NewsModel> newsModels = new ArrayList<>();
    private String state;

    public FragmentUserPublishInfo(String state) {
        this.state = state;
    }

    public FragmentUserPublishInfo() {
    }
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        userInfoAdapter = new UserPublishInfoAdapter(mContentView.getContext(), newsModels);
